  ...
  Widget build(BuildContext context) {
    ...
    if (trx['created_at'] != null) {
      ...
      if (dt != null) {
        ...
        timeText = '${dt.day} ${months[dt.month - 1]} ${dt.year}, ${dt.hour.toString().padLeft(2, '0')}:${dt.minute.toString().padLeft(2, '0')}';
      }
    }
            ...
            Row(
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: status == 'berhasil' ? const Color(0xFFE8F5E9) : const Color(0xFFFFF8E1),
                  ...
                  child: Text(
                    ...
                    style: GoogleFonts.poppins(
                      ...
                      color: status == 'berhasil' ? const Color(0xFF2E7D32) : const Color(0xFFE65100),
                    ),
                  ),
                ),
              ],
